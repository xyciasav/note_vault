...
declare global {
  interface Window {
    vaultApi: {
      ...
      getBackupSettings: () => Promise<{ backupDirectory: string; backupFrequency: 'on-close' | 'daily' | 'weekly' | 'never'; backupRetentionCount: number; allowNewImportTagSuggestions: boolean; backupEncryptionEnabled: boolean; backupEncryptionAvailable: boolean; backupStats: BackupStats }>;
      ...
      setBackupEncryption: (args: { enabled: boolean; password?: string }) => Promise<{ backupDirectory: string; backupFrequency: string; backupRetentionCount: number; allowNewImportTagSuggestions: boolean; backupEncryptionEnabled: boolean; backupEncryptionAvailable: boolean; backupStats: BackupStats }>;
